...
public class Main {
	 ...
	 * a). Нужно создать новый проект, со следующей структурой классов (3 отдельных
	 * класса):
	 * 
	 * 
	 * 
	 * b). Настроить тестовую среду
	 * (создать тестовый класс VehicleTest, пометить папку как Test sources (зеленая
	 * папка),
	 * импортировать необходимые для тестов библиотеки (JUnit, assertJ - все что
	 * было на семинаре))
